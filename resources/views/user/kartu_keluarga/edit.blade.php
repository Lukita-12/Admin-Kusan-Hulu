    ...
    <x-form.container variant="main">
        <x-form.form action="{{ route('user.pengajuan_perubahan_kk.store') }}">
            <x-form.container variant="form">
                ...
                <!-- kartu keluarga ID -->
                <x-form.input type="text" name="kartukeluarga_id" id="kartukeluarga_id" :value="old('kartukeluarga_id', $kartukeluarga->id)" class="hidden" />
                ...
                <x-form.container variant="label-input">
                    ...
                    <x-form.container variant="input-error">
                        <x-form.input type="text" name="nama" id="nama" placeholder="Nama lengkap..." value="{{ old('nama', $kartukeluarga->penduduk->first()->nama ?? '-') }}" required />
                ...
                <x-form.container variant="label-input">
                    ...
                    <x-form.container variant="input-error">
                        <x-form.select name="jenis_kelamin" id="jenis_kelamin" value="old('jenis_kelamin')" required>
                            <option value="Laki-laki" {{ old('jenis_kelamin', $kartukeluarga->penduduk->first()->jenis_kelamin) == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                            <option value="Perempuan" {{ old('jenis_kelamin', $kartukeluarga->penduduk->first()->jenis_kelamin) == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                        </x-form.select>
                ...
                <x-form.container variant="label-input">
                    ...
                    <x-form.container variant="input-error">
                        <x-form.select name="status_perkawinan" id="status_perkawinan" value="old('status_perkawinan')" required>
                            <option value="Belum kawin" {{ old('status_perkawinan', $kartukeluarga->penduduk->first()->status_perkawinan) == 'Belum kawin' ? 'selected' : '' }}>Belum kawin</option>
                            <option value="Kawin belum tercatat" {{ old('status_perkawinan', $kartukeluarga->penduduk->first()->status_perkawinan) == 'Kawin belum tercatat' ? 'selected' : '' }}>Kawin belum tercatat</option>
                            <option value="Kawin tercatat" {{ old('status_perkawinan', $kartukeluarga->penduduk->first()->status_perkawinan) == 'Kawin tercatat' ? 'selected' : '' }}>Kawin tercatat</option>
                            <option value="Cerai hidup" {{ old('status_perkawinan', $kartukeluarga->penduduk->first()->status_perkawinan) == 'Cerai hidup' ? 'selected' : '' }}>Cerai hidup</option>
                            <option value="Cerai mati" {{ old('status_perkawinan', $kartukeluarga->penduduk->first()->status_perkawinan) == 'Cerai mati' ? 'selected' : '' }}>Cerai mati</option>
                        </x-form.select>
                ...
                <x-form.container variant="label-input">
                    ...
                    <x-form.container variant="input-error">
                        <x-form.input type="text" name="tempat_lahir" id="tempat_lahir" value="{{ old('tempat_lahir', $kartukeluarga->penduduk->first()->tempat_lahir) }}" placeholder="Tempat lahir..." required />
                ...
                <x-form.container variant="label-input">
                    ...
                    <x-form.container variant="input-error">
                        <x-form.input type="date" name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir', $kartukeluarga->penduduk->first()->tanggal_lahir->format('Y-m-d')) }}" placeholder="Tanggal lahir..." required />
                ...
                <x-form.container variant="label-input">
                    ...
                    <x-form.container variant="input-error">
                        <x-form.input type="text" name="agama" id="agama" value="{{ old('agama', $kartukeluarga->penduduk->first()->agama) }}" placeholder="Agama..." required />
                ...
                <x-form.container variant="label-input">
                    ...
                    <x-form.container variant="input-error">
                        <x-form.input type="text" name="pendidikan_terakhir" id="pendidikan_terakhir" value="{{ old('pendidikan_terakhir', $kartukeluarga->penduduk->first()->pendidikan_terakhir) }}" placeholder="Pendidikan terakhir..." required />
                ...
                <x-form.container variant="label-input">
                    ...
                    <x-form.container variant="input-error">
                        <x-form.input type="text" name="pekerjaan" id="pekerjaan" value="{{ old('pekerjaan', $kartukeluarga->penduduk->first()->pekerjaan) }}" placeholder="Pekerjaan..." required />
                ...
                <x-form.container variant="label-input">
                    ...
                    <x-form.container variant="input-error">
                        <x-form.textarea name="alamat_lengkap" id="alamat_lengkap" placeholder="Alamat lengkap..." required>{{ old('alamat_lengkap', $kartukeluarga->penduduk->first()->alamat_lengkap) }}</x-form.textarea>
                ...
                <x-form.container variant="label-input">
                    ...
                    <x-form.container variant="input-error">
                        <x-form.input type="text" name="kedudukan_dalam_keluarga" id="kedudukan_dalam_keluarga" value="{{ old('kedudukan_dalam_keluarga', $kartukeluarga->penduduk->first()->kedudukan_dalam_keluarga) }}" placeholder="Kedudukan dalam keluarga..." required />
                ...
                <x-form.container variant="label-input">
                    ...
                    <x-form.container variant="input-error">
                        <x-form.input type="text" name="warga_negara" id="warga_negara" value="{{ old('warga_negara', $kartukeluarga->penduduk->first()->warga_negara) }}" placeholder="Warga negara..." required />
