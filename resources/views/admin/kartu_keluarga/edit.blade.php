<x-layout>
    ...
    <x-form.container variant="main">
        <x-form.form action="{{ route('admin.kartu_keluarga.update', $kartukeluarga) }}">
            @method('PUT')
            ...
            <x-form.container variant="form">
                <x-form.container variant="label-input">
                    ...
                    <x-form.container variant="input-error">
                        <x-form.input type="text" name="no_kk" id="no_kk" value="{{ old('no_kk', $kartukeluarga->no_kk ?? '-') }}" placeholder="Nomor kartu keluarga..." required />
                ...
                <x-form.container variant="label-input">
                    ...
                    <x-form.container variant="input-error">
                        <x-form.input type="text" name="kelurahan_desa" id="kelurahan_desa" value="{{ old('kelurahan_desa', $kartukeluarga->kelurahan_desa ?? '-') }}" placeholder="Kelurahan/Desa..." />
