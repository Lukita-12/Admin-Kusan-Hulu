...
class SuratKartuKeluargaController extends Controller
{
    /**
    ...
    {
        $pengajuanPerubahanKK = PengajuanPerubahanKK::with('penduduk')->findOrFail($id);

    return view('admin.kartu_keluarga.surat', compact('pengajuanPerubahanKK'));
    }
